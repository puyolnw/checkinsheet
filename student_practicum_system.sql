...
--
-- Host: localhost
-- Generation Time: Sep 10, 2025 at 09:32 PM
...
CREATE TABLE `academic_years` (
  `id` int(11) NOT NULL,
  `year` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ปีการศึกษา (เช่น 2568)',
  `year_thai` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ปีการศึกษา (ภาษาไทย)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางจัดการปีการศึกษา';
...
CREATE TABLE `activity_categories` (
  `id` int(11) NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ชื่อหมวดหมู่',
  `name_thai` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ชื่อหมวดหมู่ (ภาษาไทย)',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'คำอธิบายหมวดหมู่',
  `color` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '#007bff' COMMENT 'สีของหมวดหมู่ (HEX)',
  `icon` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'ไอคอนของหมวดหมู่',
  `is_active` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'สถานะใช้งาน',
  `created_by` int(11) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='หมวดหมู่กิจกรรม';
...
CREATE TABLE `activity_reschedule_history` (
  ...
  `reason` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'เหตุผลในการเลื่อนวัน',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ประวัติการเลื่อนวันกิจกรรม';
...
CREATE TABLE `activity_status_history` (
  `id` int(11) NOT NULL,
  `activity_id` int(11) NOT NULL,
  `old_status` enum('DRAFT','OPEN','CLOSED','CANCELLED') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `new_status` enum('DRAFT','OPEN','CLOSED','CANCELLED') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `changed_by` int(11) NOT NULL,
  `reason` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'เหตุผลในการเปลี่ยนสถานะ',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ประวัติการเปลี่ยนแปลงสถานะกิจกรรม';
...
CREATE TABLE `activity_tags` (
  `id` int(11) NOT NULL,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ชื่อแท็ก',
  `color` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '#6c757d' COMMENT 'สีของแท็ก (HEX)',
  `created_by` int(11) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='แท็กกิจกรรม';
...
CREATE TABLE `activity_tag_relations` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ความสัมพันธ์ระหว่างกิจกรรมกับแท็ก';
...
CREATE TABLE `backup_activities` (
  ...
  `end_date` datetime NOT NULL,
  `hours_awarded` int(11) NOT NULL DEFAULT '1',
  `public_slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `status` enum('DRAFT','OPEN','CLOSED','CANCELLED') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'DRAFT',
  `academic_year` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `deletion_reason` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'เหตุผลในการลบ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='สำรองข้อมูลกิจกรรมที่ถูกลบ';
...
CREATE TABLE `system_logs` (
  `id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `action` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'การกระทำ (เช่น CREATE_ACTIVITY, UPDATE_ACTIVITY)',
  `table_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'ชื่อตารางที่เกี่ยวข้อง',
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Log ระบบสำหรับติดตามการทำงาน';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ชั่วโมงกิจกรรมของนักศึกษาตามปีการศึกษา';
